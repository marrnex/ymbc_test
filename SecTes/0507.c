     ...
     // }
      fputs("e\n", fp);
               ...
               // fputs("e\n", fp);
                ...
                a=(yob[ysel]-yob[xmin])/(xob[ysel]-xob[xmin]);//入り口2点の傾き
  ...
  //                Spur_spin_LC(M_PI/2);
    //              usleep(2000000);
                 ...
                 //Spur_stop_line_FS( perp(xob[xmin],yob[xmin],xob[xmin2],yob[xmin2],(xob[xmin]+xob[xmin2])/2,(yob[xmin]+yob[xmin2])/2),0 , 0 );
                  ...
                  Spur_stop_line_FS( ((xob[xmin]+xob[xmin2])/2), -( (yob[xmin]+yob[xmin2])/2), atan(-( (yob[xmin]+yob[xmin2])/2)/((xob[xmin]+xob[xmin2])/2)) );
